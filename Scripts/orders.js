...
import {
  updateTrackingHTML,
  arrivingOnOrNot,
} from "../backendData/trackingdata.js";
...
orders.forEach((order) => {
  ordersHTML += `<div class="orders-container-header">
  ...
  order.items.forEach((item) => {
    ...
    ordersHTML += `<div class="order-details-grid">
            ...
            <div class="product-details">
                ...
                <a href="cart.html">
                    <button class="buy-again-button button-primary js-buy-again-button" data-id="${itemID}" data-quantity="${
      item.quantity
    }" >
            ...
            <a href="tracking.html">
                <button class="track-package-button button-secondary js-track-package-button" data-id="${itemID}" data-order-id="${
      order.orderId
    }">
                    Track package
                </button>
...
if (orders.length === 0) {
  document.querySelector(
    ".js-orders-container"
  ).innerHTML = `You have placed no orders 
    <br>
    <a href="index.html">
