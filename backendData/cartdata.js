...
export function FormattedDeliveryDate(optionPicked) {
  switch (optionPicked) {
    case 0:
      return getMonthAndDate(today);
    case 1:
      return getMonthAndDate(lastDate);
    case 2:
      return getMonthAndDate(todayPlus3);
    case 3:
      return getMonthAndDate(tomorrow);
  }
}
...
export function placeOrder() {
  ...
  cart.forEach((cartItem) => {
    cartitem.push({
      ...
      arrivingDate: FormattedDeliveryDate(cartItem.deliveryDate),
    });
    deleteItemFromCart(cartItem.id);
  });
  orders.push({
    orderId: generateOrderId(),
    orderDate: FormattedDeliveryDate(0),
